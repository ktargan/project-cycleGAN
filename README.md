...
## Results 
Some tables providing the results of training the model with small ablations are provided in the folder 'results'. The table showcases images that were generated by the respective model after 30 epochs. 
